...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SoundStream — Live Radio & Podcasts" },
      {
        name: "description",
        content:
          "SoundStream: 24/7 live radio, curated podcasts, and immersive music culture. Tune in, discover new sounds, and connect with hosts.",
      },
      { property: "og:title", content: "SoundStream — Live Radio & Podcasts" },
      {
        property: "og:description",
        content: "24/7 live radio, curated podcasts, and immersive music culture.",
      },
